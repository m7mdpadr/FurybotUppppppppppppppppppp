...
client.on('message',async message => {
  ...
  if(message.content.startsWith(prefix + "bcall")) {
    ...
    if(message.author.id !== '316324088865882142') return message.channel.send('❎ » هذا الأمر مخصص لصاحب البوت فقط');
...
client.channels.get("496896798863130626").send(`:white_check_mark: **${client.user.tag} دخل سيرفر جديد
...
client.on('guildDelete', guild => {
  client.channels.get("496896798863130626").send(`:negative_squared_cross_mark: **${client.user.tag} طلع من سيرفر
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
